...
object ApiConfig {
    ...
    const val GH_PROXY_BASE_URL = "${GH_PROXY_ROOT}AlfaazPlus/QuranApp/mediaplayer/" // fixme
    const val JS_DELIVR_BASE_URL = "${JS_DELIVR_ROOT}AlfaazPlus/QuranApp@latest/"
    const val GH_RAW_BASE_URL = "${GH_RAW_ROOT}AlfaazPlus/QuranApp/mediaplayer/" // fixme
